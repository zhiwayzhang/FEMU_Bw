...
void ssd_init(FemuCtrl *n) {
  ...
  ssd->statistic_end_time =
      qemu_clock_get_ns(QEMU_CLOCK_REALTIME) + ssd->sampling_interval;
...
//         lunp->next_lun_avail_time); uint64_t desc = now_time -
//         lunp->next_lun_avail_time; if (desc >= sampling_interval) {
//             continue;
//         } else {
...
// }
// ftl_log("\ntotal_util=%"PRIu64"\ndivide_by=%d\n",
// total_util/sampling_interval, spp->tt_luns); ftl_log("\n%lf\n",
